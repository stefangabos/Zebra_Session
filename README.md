...
[![Latest Stable Version](https://img.shields.io/packagist/v/stefangabos/zebra_session)](https://packagist.org/packages/stefangabos/zebra_session) [![Total Downloads](https://img.shields.io/packagist/dt/stefangabos/zebra_session)](https://packagist.org/packages/stefangabos/zebra_session) [![Monthly Downloads](https://img.shields.io/packagist/dm/stefangabos/zebra_session)](https://packagist.org/packages/stefangabos/zebra_session) [![Tests](https://img.shields.io/github/actions/workflow/status/stefangabos/Zebra_Session/tests.yml?branch=master&label=tests)](https://github.com/stefangabos/Zebra_Session/actions/workflows/tests.yml) [![PHP](https://img.shields.io/packagist/dependency-v/stefangabos/zebra_session/php)](https://packagist.org/packages/stefangabos/zebra_session) [![License](https://img.shields.io/packagist/l/stefangabos/zebra_session)](https://packagist.org/packages/stefangabos/zebra_session)
...
The test suite is not part of the released package - if you want to run it you need a git checkout of the
repository.

The tests run against a real MySQL instance, creating and dropping their own table in a database of their
own, so point them at a server you are happy for them to write to.
...
With no arguments it runs the suite and then the compatibility, static analysis and coding standard checks.
...
[pcov](https://github.com/krakjoe/pcov) or [Xdebug](https://xdebug.org/):
